...
public class UserMyPostsActivity extends BaseActivity implements OnClickListener {
        ...
        mPullList.getRefreshableView().setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (CommonUtil.isNetworkAvailable(UserMyPostsActivity.this) == 0) {
                    ToastUtils.showInfo(UserMyPostsActivity.this, ConstantValues.NONETWORK);
                } else {
                    CommunityPostsEntity bean = (CommunityPostsEntity) adapter.getItem(position);
    ...
    public void initData() {
        ...
        mTitle.setText(CheckUtils.checkEmpty(getIntent().getStringExtra("user_id")) ? "我的帖子" : "他的帖子");
        getData();
    }
                ...
                public void getIOAuthCallBack(String result) {
                    ...
                    if (result.equals(ConstantValues.FAILURE)) {
                        ...
                        if ("1".equals(bean.getStatus())) {
                            ...
                            ArrayList<CommunityPostsEntity> mList = adapter.getPosts_list();
                            if (data.size() == 0) {
                                // 没有更多数据
                                ToastUtils.showInfo(UserMyPostsActivity.this, ConstantValues.NOMORE);
                                dialog.cancel();
                                onLoaded();
                                return;
                            }
