...
public class OrderScuessActivity extends BaseActivity implements OnClickListener
{
    ...
    public void initData() {
        View layout = View.inflate(this, R.layout.item_ordersuccess_popwindows, null);
        ...
        try {
            ...
            ServiceFactory.getIUserEngineInstatice().toPay(sn, user_id, payment, new IOAuthCallBack() {
                ...
                public void getIOAuthCallBack(String result)
                {
                    ...
                    {
                        ToastUtils.showInfo(OrderScuessActivity.this, beans.getInfo());
                    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_share:
                if(!FileUtils.isFile("redpack_img.jpg"))
                    FileUtils.saveBitToSD(FileUtils.drawableToBitamp(getResources().getDrawable(R.drawable.app_logo)),"redpack_img");
                String imagename="redpack_img.jpg";
                ShareUtils.showShareandUrl(sharetitle,share_content, shareUrl, this, CheckUtils.checkEmpty(imagename) ? "" : imagename);
                break;
            default:
                break;
        }
