...
public class PracticeListActivity extends BaseActivity implements OnClickListener, TextWatcher {
    ...
    private ArrayList<PracticeEntity> list;
    private boolean isR;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pull_refresh_list.getRefreshableView().setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                int rgid = adapter.getItem(position).getRgid();
                if (CommonUtil.isNetworkAvailable(getApplicationContext()) == 0 & rgid != -1) {
                    ...
                    intent.putExtra("rgname", adapter.getItem(position).getRgname());
    ...
    public void getData() {
        ...
        ServiceFactory.getPracEngineInstatice().findPracticeSearch(cityid, rgname, longitude, latitude, type, new IOAuthCallBack() {
            ...
            public void getIOAuthCallBack(String result) {
                if (result.equals(ConstantValues.FAILURE)) {
                    ...
                    if (bean.getData().size() == 0 & !isR) {
                        ...
                        ArrayList<PracticeEntity> data = bean.getData();
                        list = (ArrayList<PracticeEntity>) adapter.getList();
