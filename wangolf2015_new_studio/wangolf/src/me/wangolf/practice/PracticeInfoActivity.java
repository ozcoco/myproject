...
import me.wangolf.bean.practice.PracDetailEntity_new.DataEntity.DistributorsEntity;
		...
		OnClickListener, OnItemClickListener, Thread.UncaughtExceptionHandler
{
	...
	public void setView()
	{
		hardView = (LinearLayout) View
				.inflate(this, R.layout.head_practice, null);

		footView = (LinearLayout) View
				.inflate(this, R.layout.item_practice_info_foot, null);
	...
	public void getData()
	{
		ServiceFactory.getPracEngineInstatice()
				.getPracticeInfo(rgid, new IOAuthCallBack()
				{
					...
					public void getIOAuthCallBack(String result)
					{
						...
						else
						{
							...
							bean = GsonTools
									.changeGsonToBean(result, PracDetailEntity_new.class);
							...
							{
								ToastUtils
										.showInfo(PracticeInfoActivity.this, ConstantValues.NONETWORK);
							}
							else
							{
								data = datas.get(0);
								...
								// // layout_coachs.setVisibility(View.GONE); //
								// 0表示没有教练
	...
	public void setPracticeInfo(DataEntity bean)
	{
		...
		mTeeFloorNum.setText(mTeeFloorNum.getText() + ":" + bean
				.getTee_floor_num());
	...
	public void toBuyPractice(DistributorsEntity bean)
	{
					...
					public void getIOAuthCallBack(String result)
					{
						...
						else
						{
							...
							try
							{
								...
								{
									bm = BitmapFactory
											.decodeStream(PracticeInfoActivity.this
