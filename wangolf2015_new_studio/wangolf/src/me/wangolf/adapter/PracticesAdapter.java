...
public class PracticesAdapter extends BaseAdapter 
{
    ...
    private ArrayList<PracticeEntity.DataEntity> list = new ArrayList<PracticeEntity.DataEntity>();
    ...
    public ArrayList<PracticeEntity.DataEntity> getList() 
    {
        return list;
    }

    public void setList(List<PracticeEntity.DataEntity> data) 
    {
        this.list = (ArrayList<DataEntity>) data;
    }
    ...
    @Override
    public PracticeEntity.DataEntity getItem(int item) 
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) 
    {
        ...
        {
            // 获取指定位置的数据
        	PracticeEntity.DataEntity bean = getItem(position);
            // 绑定数据到item界面
            holder.tvBallName.setText(bean.getRange_name());
            ...
            holder.mCoach.setText(bean.getHas_message());
    ...
    {
        private PracticeEntity.DataEntity bean;

        public toTel(PracticeEntity.DataEntity bean) 
        {
            this.bean = bean;
        }
