package me.wangolf.utils.viewUtils;
...
public class RollViewPager_NORoll_Community extends ViewPager {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			RollViewPager_NORoll_Community.this.setCurrentItem(currentItem);
			startRoll();
		}
	};


	public RollViewPager_NORoll_Community(Context context, ArrayList<View> dots, int dot_focus_resId, int dot_normal_resId, OnPagerClickCallback onPagerClickCallback) {
		super(context);
	...
	class ViewPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View container, final int position) {
			View view = View.inflate(context, R.layout.viewpager_community_item, null);
			((ViewPager) container).addView(view);
			view.setOnTouchListener(myOnTouchListener);
			ImageView imageView = (ImageView) view.findViewById(R.id.chzz_viewpage_image);
			if (isShowResImage) {
