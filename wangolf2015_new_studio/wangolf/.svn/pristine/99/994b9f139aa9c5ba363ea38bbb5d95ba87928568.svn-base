 ...
 */
public class KnowledgeChannelActivity extends Activity implements OnItemClickListener, OnClickListener {
    /**
     * 用户栏目的GRIDVIEW
     */
    ...
    private KnowledgeChannelManage channelManage;
    long mLastTime = 0;
    ...
    private void initData() {
        ...
        channelManage = new KnowledgeChannelManage(LocationApplication.getApp().getSQLHelper(),tableName);
    ...
    private void saveChannel() {
        ...
        for (int i = 0; i < userAdapter.getChannnelLst().size(); i++) {
            ...
            ConstantValues.knoledge_title_name[i] = data.get(i).getName();
            ConstantValues.knoledge_title_id[i] = data.get(i).getId();
        }
        ConstantValues.knoledge_title_size = userAdapter.getChannnelLst().size();
