...
public class RollViewPager_NORoll extends ViewPager {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			RollViewPager_NORoll.this.setCurrentItem(currentItem);
			startRoll();
		}
	};

	public RollViewPager_NORoll(Context context, ArrayList<View> dots, int dot_focus_resId, int dot_normal_resId, OnPagerClickCallback onPagerClickCallback) {
		super(context);
