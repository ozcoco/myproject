...
public class CommunityDetailImgAdapter extends BaseAdapter {
	private Context context;
	private String[] img;

	public CommunityDetailImgAdapter(Context context) {
		super();
		this.context = context;
	}

	public CommunityDetailImgAdapter(Context context, String[] img) {
		super();
		this.context = context;
		this.img = img;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(context, R.layout.item_comm_detail_img, null);
