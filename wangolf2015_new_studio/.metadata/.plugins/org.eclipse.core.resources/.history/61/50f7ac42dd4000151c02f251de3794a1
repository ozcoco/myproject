...
public class AddressAdapter extends BaseAdapter {
	...
	private List<RespUserAdrrEntity.DataEntity> list = new ArrayList<RespUserAdrrEntity.DataEntity>();
	...
	public List<RespUserAdrrEntity.DataEntity> getList() 
	{
		return list;
	}

	public void setList(List<RespUserAdrrEntity.DataEntity> list) 
	{
		this.list = list;
	}
	...
	@Override
	public RespUserAdrrEntity.DataEntity getItem(int position) 
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent) 
	{
		...
		RespUserAdrrEntity.DataEntity bean = list.get(position);
		
		holder.consignee.setText(bean.getConsignee() == null ? "" : bean.getConsignee());
		
		holder.phone.setText(bean.getMobile() == null ? "" : bean.getMobile());
		
		HashMap<String, String> map = new CityDao(context).getResUserAdrr(/*bean.getRid1()*/null, bean.getProvince_id(), bean.getCity_id(), bean.getArea_id());
		...
		v.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View arg0)
			{
				...
				RespUserAdrrEntity.DataEntity beans = (RespUserAdrrEntity.DataEntity) v.getTag();
				
				AddressBean bean = new AddressBean();
				
				bean.setAid(beans.getId() + "");
				
				bean.setRid2(beans.getProvince_id());
				
				bean.setRid3(beans.getCity_id());
				
				bean.setRid4(beans.getArea_id());
	 ...
	 * @param bean
	 */
	private void saveAdress(RespUserAdrrEntity.DataEntity bean) {
